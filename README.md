...
│   ├── TRUST_MODEL.md               # Graduated trust specification
│   ├── COORDINATION_PROTOCOL.md     # Exchange quality patterns
...
│   ├── behavior-monitor.js          # Runtime behavioral analysis
│   ├── provenance-chain.js          # Skill verification logic
│   └── sensor-bridge.js             # Physical infrastructure interface
├── tests/
│   ├── trust-graduation.test.js
│   ├── provenance-verification.test.js
│   └── coordination-coherence.test.js
└── examples/
